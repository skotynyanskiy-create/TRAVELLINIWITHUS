            ...
            <div>
              ...
              <div className="mt-8 flex flex-wrap gap-3">
                <a
                  ...
                  className="inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-purple-500 via-pink-500 to-orange-400 px-6 py-3 text-xs font-bold uppercase tracking-widest text-white transition-opacity hover:opacity-90"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 rounded-full bg-[#1877F2] px-6 py-3 text-xs font-bold uppercase tracking-widest text-white transition-opacity hover:opacity-90"
                >
                  <svg viewBox="0 0 24 24" className="h-3.5 w-3.5 fill-current" aria-hidden="true">
            ...
            <div className="grid grid-cols-2 gap-4">
              {([
                ...
                <motion.div
                  ...
                  className="rounded-xl border border-white/8 border-t border-t-[var(--color-gold)]/20 bg-[#1C1C1C] p-5 transition-colors hover:bg-[#242424]"
                >
