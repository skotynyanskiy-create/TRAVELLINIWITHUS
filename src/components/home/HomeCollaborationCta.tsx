        ...
        <div className="grid gap-8 border-y border-white/10 py-10 md:grid-cols-[1fr_auto] md:items-center md:py-12">
          <div>
            ...
            <p className="mt-5 max-w-2xl text-base leading-relaxed text-white/70 md:text-lg">
              Lavoriamo con realta travel, hospitality e lifestyle quando c e allineamento reale tra
              progetto, pubblico e liberta editoriale.
            </p>
          </div>
          ...
          <div className="flex flex-col gap-3 sm:flex-row md:flex-col lg:flex-row">
            <Link
              to="/collaborazioni"
              className="inline-flex h-12 items-center justify-center gap-2 rounded-lg bg-[var(--color-gold)] px-6 text-xs font-bold uppercase tracking-widest text-white transition-all hover:brightness-110"
            >
              Scopri le collaborazioni <ArrowRight size={14} />
            </Link>
            <Link
              to="/media-kit"
              className="inline-flex h-12 items-center justify-center rounded-lg border border-white/18 px-6 text-xs font-bold uppercase tracking-widest text-white/76 transition-colors hover:border-[var(--color-gold)] hover:text-[var(--color-gold)]"
            >
