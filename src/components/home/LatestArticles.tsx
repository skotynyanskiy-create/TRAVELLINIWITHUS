...
import LatestArticlesCarousel, { type CarouselArticle } from './LatestArticlesCarousel';
...
export default function LatestArticles() {
  ...
  const recentArticles = (recentArticlesData?.articles ?? []) as CarouselArticle[];
    ...
    <section id="storie" className="bg-white py-20 md:py-24">
      <div className="mx-auto max-w-7xl px-6 md:px-12">
        ...
        {loadingArticles ? (
          ...
          <LatestArticlesCarousel articles={recentArticles} />
        ) : (
