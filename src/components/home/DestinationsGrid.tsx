...
export default function DestinationsGrid() {
  return (
    <Section title="Esplora per filtro" subtitle="Destinazioni ed Esperienze" className="bg-white" ornament>
      <div className="grid gap-6 lg:grid-cols-12">
        ...
        >
          <div className="absolute inset-0 opacity-15">
            <OptimizedImage
              src="https://images.unsplash.com/photo-1516483638261-f4dbaf036963?q=80&w=800"
              alt=""
          ...
          <div className="relative z-10">
            ...
            <h3 className="text-3xl font-serif leading-tight md:text-4xl">
              Esplora per luogo.<br />
              <span className="font-script text-[var(--color-accent-warm)] text-[0.8em]">Italia, Europa e oltre.</span>
            </h3>
        ...
        >
          ...
          <div>
            <div className="text-[10px] font-bold uppercase tracking-[0.22em] text-[var(--color-accent)] mb-3">Esperienze</div>
            <h3 className="text-2xl font-serif leading-tight text-ink md:text-3xl">Lo stesso archivio, diviso per stile di viaggio.</h3>
