      ...
      <div className="mx-auto w-full max-w-7xl px-4 md:px-8">
        <div className="mb-12 md:flex md:items-end md:justify-between">
          <div className="max-w-2xl">
            <span className="mb-3 block font-script text-xl text-[var(--color-accent-warm)]">Le nostre guide</span>
            <h2 className="text-3xl font-serif leading-tight md:text-4xl">Guide pratiche per viaggiare meglio.</h2>
            <p className="mt-4 text-base font-normal text-white/85">
              Strumenti digitali per organizzare i tuoi viaggi, ottimizzare il budget e partire davvero preparato.
            </p>
          </div>
          <Link
            to="/shop"
        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
          {loadingProducts ? (
            ...
            <div className="col-span-full py-16 flex flex-col items-center gap-6">
              ...
              <Link to="/shop" className="text-xs font-bold uppercase tracking-[0.2em] text-[var(--color-gold)] transition-colors hover:text-[var(--color-accent-warm)]">
