...
export default function AffiliateBox({
  ...
  return (
    <div className="my-10 bg-white rounded-[var(--radius-lg)] border border-black/5 shadow-sm overflow-hidden flex flex-col sm:flex-row group hover:shadow-md transition-all duration-300">
      {image && (
      ...
      <div className="p-6 sm:p-8 flex-1 flex flex-col justify-center">
        <div className="flex items-center gap-3 mb-4">
          <div
            className={`w-10 h-10 rounded-full ${config.bgLight} flex items-center justify-center`}
          >
            {config.icon}
          </div>
          <div>
            <span className="uppercase tracking-widest text-[10px] font-bold text-black/40 block">
              Consigliato da noi
            </span>
        ...
        <p className="text-black/60 font-light text-sm leading-relaxed mb-6">{description}</p>
