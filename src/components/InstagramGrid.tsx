...
const INSTA_IMAGES = [
  ...
  'https://images.unsplash.com/photo-1504598318550-17eba1008a68?q=80&w=800&auto=format&fit=crop',
];

export default function InstagramGrid() {
  return (
    <section className="bg-white pb-0 pt-16 md:pt-20">
      <div className="flex w-full items-end justify-between px-6 pb-6 md:px-12">
        <div>
          <span className="mb-3 block text-[10px] font-bold uppercase tracking-[0.3em] text-[var(--color-accent-text)]">
            Instagram
          </span>
          <h3 className="text-2xl font-serif text-ink md:text-3xl">Dal profilo di Rodrigo & Betta</h3>
          <p className="mt-1.5 text-sm text-black/55">
            <span className="font-semibold text-black/70">{CONTACTS.instagramHandle}</span> — Scatti, storie e posti particolari
          </p>
        </div>
        <a
