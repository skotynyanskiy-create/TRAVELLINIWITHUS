...
// Fallback = cover e hook REALI dei reel pubblicati (imagery truth 2026-07-22):
// niente immagini AI né caption inventate. Usato solo se il manifest è vuoto.
const FALLBACK_ITEMS: InstaItem[] = [
  {
    image: '/images/reels/reel-1-cover.webp',
    type: 'reel',
    caption: 'Mar Rosso senza spendere una fortuna.',
    alt: "Acqua trasparente del Mar Rosso vista da sott'acqua a Marsa Alam",
  ...
  },
  {
    ...
    type: 'reel',
    caption: 'Il sushi più bello della Toscana?',
  ...
  },
  {
    ...
    type: 'reel',
    caption: 'Batu Caves: vale la pena?',
    alt: 'La scalinata arcobaleno delle Batu Caves a Kuala Lumpur',
    url: 'https://www.instagram.com/travelliniwithus/',
    span: 'square',
  },
  {
    image: '/images/reels/novara-emotional-grand-motel-cover.webp',
    type: 'reel',
    caption: 'Dormiresti in una gabbia?',
    alt: "Camera a tema con letto dentro una gabbia dorata all'Emotional Grand Motel",
    url: 'https://www.instagram.com/travelliniwithus/',
    span: 'square',
  },
  {
    image: '/images/reels/ravenna-better-sushi-cover.webp',
    type: 'reel',
    caption: 'Il sushi più bello della Romagna?',
    alt: "Ambiente scenografico con cascate e passerelle sull'acqua da Better Sushi a Ravenna",
    url: 'https://www.instagram.com/travelliniwithus/',
    span: 'wide',
  },
  {
    image: '/images/reels/londra-warner-bros-studio-harry-potter-cover.webp',
    type: 'reel',
    caption: 'Credi nella magia?',
    alt: 'Set del tour Warner Bros. di Harry Potter a Londra',
    url: 'https://www.instagram.com/travelliniwithus/',
    span: 'tall',
  },
];
