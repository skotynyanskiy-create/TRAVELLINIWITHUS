...
export default function SEOPreview({
  ...
  return (
    <div className="bg-white border border-zinc-200 rounded-[var(--radius-md)] overflow-hidden shadow-sm">
      ...
      <div className="p-6 space-y-8">
        ...
        <div>
          ...
          <div className="max-w-[500px] border border-zinc-200 rounded-xl overflow-hidden bg-[#f2f3f5]">
            ...
            <div className="p-3">
              <p className="text-[12px] text-zinc-500 uppercase font-medium mb-1">
                senza-confini.it
              </p>
