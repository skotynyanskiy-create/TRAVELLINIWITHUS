      ...
      <div className="bg-[var(--color-sand)] p-8 md:p-12 rounded-[var(--radius-lg)] flex flex-col md:flex-row gap-8 items-center md:items-start">
        ...
        <div className="flex-1">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <Link
              to="/chi-siamo"
              className="inline-flex items-center gap-2 px-5 py-2.5 border border-black/15 text-black text-xs font-bold uppercase tracking-widest rounded-full hover:border-accent hover:text-accent transition-colors"
            >
              Chi siamo
            </Link>
          </div>
