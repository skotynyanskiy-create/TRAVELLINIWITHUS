...
export default function SocialFollowCTA() {
  return (
    <div className="mt-16 grid grid-cols-1 sm:grid-cols-2 gap-6">
      ...
      >
        <div className="w-14 h-14 rounded-[var(--radius-md)] bg-white/20 flex items-center justify-center shrink-0">
          <Instagram size={28} />
        </div>
        <div>
        ...
        <ArrowRight
          size={20}
          className="absolute right-6 top-1/2 -translate-y-1/2 opacity-50 group-hover:opacity-100 group-hover:translate-x-1 transition-all"
        />
      </a>
