...
import { BRAND_COPY, CONTACTS, BRAND_STATS, SITE_URL } from '../config/site';
          ...
          <div className="order-2 flex flex-col justify-center lg:order-1">
            ...
            <div className="relative mb-8 inline-block">
              <h1 className="text-display-1">
                ...
                <span className="italic text-black/60">{BRAND_COPY.aboutHeroAccent}</span>
              </h1>
              <motion.span
            ...
            <div className="mb-10 space-y-6 text-lg font-light leading-relaxed text-black/70">
              <p>Siamo Gaetano Rodrigo e Betta. Dopo {BRAND_STATS.yearsOfTravel} anni di viaggi in coppia, weekend improvvisati, road trip on a budget e food experience cercate nei vicoli, abbiamo smesso di aspettare la guida perfetta e abbiamo iniziato a scriverla noi.</p>
              <p>Il nostro taglio e semplice: viaggiare bene spendendo meno, mangiare dove mangiano i locali, scoprire posti che non finiscono su tutti i feed uguali. Con {BRAND_STATS.instagramFollowers} su Instagram e {BRAND_STATS.tiktokFollowers} su TikTok, la Travellini Community e la nostra comunita vera.</p>
            </div>
