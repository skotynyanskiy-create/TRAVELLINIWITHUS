...
describe('ArticleBody — direttive editoriali (verified, fullbleed, pullquote, source)', () => {
  it('renderizza :::verified::: come VerifiedBox con badge, date formattate e contatti', () => {
  ...
  it('renderizza :::fullbleed::: come FullBleedFigure con src/alt/ratio/caption/credit dalla prima image', () => {
    const { container } = render(<ArticleBody article={makeArticle()} />);
  ...
  it('renderizza :::pullquote::: come blockquote con attribuzione estratta dal corpo', () => {
    const { container } = render(<ArticleBody article={makeArticle()} />);
  ...
  it('renderizza :::source::: come SourceBlock con href, autore e badge verified', () => {
    const { container } = render(<ArticleBody article={makeArticle()} />);
