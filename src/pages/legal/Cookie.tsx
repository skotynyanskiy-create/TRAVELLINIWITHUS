      ...
      <Section className="pt-8">
        ...
        <div className="mt-8 rounded-[var(--radius-lg)] border border-black/5 bg-white p-10 shadow-sm md:p-16">
          ...
          <div className="prose prose-slate max-w-none space-y-6 font-light leading-relaxed text-black/70">
            ...
            <p>
              I cookie sono piccoli file di testo salvati sul dispositivo dell&apos;utente durante
              la navigazione. Possono servire a ricordare preferenze, mantenere attive alcune
              funzioni o comprendere in modo tecnico come viene usato il sito.
            </p>
            ...
            <p>
              ...
              strumenti analitici o di terze parti utilizzati per comprendere l&apos;uso delle
              pagine o supportare servizi esterni collegati.
            </p>
            ...
            <p>
              Alcune pagine possono rimandare a piattaforme esterne o integrare servizi che adottano
              una propria cookie policy. Per questi servizi fanno fede le informative pubblicate dai
