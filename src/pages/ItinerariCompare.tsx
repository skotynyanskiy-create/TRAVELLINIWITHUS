            ...
            >
              ...
              <div className="p-5">
                ...
                <Link
                  ...
                  className="mt-4 inline-flex items-center gap-2 py-1.5 text-[10px] font-bold uppercase tracking-[0.22em] text-[var(--color-ink)] transition-colors hover:text-[var(--color-accent-text)]"
                >
