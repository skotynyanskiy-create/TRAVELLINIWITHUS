...
const reasons = [
  {
    ...
    text: 'Non stiamo vendendo file decorativi. Stiamo raccogliendo cio che ci ha aiutato davvero a viaggiare meglio.',
  },
  {
...
function Shop() {
  ...
  const {
    ...
    queryKey: ['products', shopDemoEnabled],
    queryFn: async () => {
      ...
      return shopDemoEnabled ? [DEMO_PRODUCT as Product] : [];
    },
  });
              ...
              >
                {paymentStatus === 'success' ? (
                  ...
                  <>
                    ...
                    <p className="text-zinc-600 mb-8">
                      Il processo di pagamento e stato interrotto. Nessun addebito e stato
                      effettuato.
                    </p>
                  </>
                )}
          ...
          {!isLoading && products.length === 0 && (
            <div className="mt-12 rounded-[2rem] border border-black/5 bg-white p-10 text-center shadow-sm">
              <p className="text-[10px] font-bold uppercase tracking-[0.24em] text-accent">
                Apertura shop in preparazione
              </p>
              <h2 className="mt-4 text-3xl font-serif">Le prime guide digitali arrivano qui</h2>
              <p className="mx-auto mt-4 max-w-2xl text-base font-normal leading-relaxed text-black/70">
                Lo shop non mostra prodotti finti o annunci ambigui. Quando apriremo il catalogo,
                troverai qui solo guide reali, planner utili e risorse pubblicate davvero.
              </p>
              <div className="mt-8 flex flex-col items-center justify-center gap-4 sm:flex-row">
                <Button to="/contatti" variant="primary">
                  Chiedi aggiornamenti
                  <ArrowRight size={18} />
                </Button>
                <a
                  href="#newsletter"
                  className="text-xs font-bold uppercase tracking-widest text-black/50 transition-colors hover:text-[var(--color-accent)]"
                >
            ...
            <div className="relative z-20 h-full flex flex-col justify-center px-6 md:px-12 lg:px-24">
              ...
              >
                ...
                <p className="text-xl text-white/70 font-light leading-relaxed mb-12 max-w-xl">
                  ...
                  planner e nato in viaggio, testato sul campo, pensato per aiutarti a partire
                  davvero preparato.
                </p>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                  <div className="p-8 rounded-3xl bg-[#1C1C1C] border border-white/8">
                    ...
                    <p className="text-sm text-white/50 font-light leading-relaxed">
                      ...
                      in aereo o cammini per la citta.
                    </p>
                  </div>
                  <div className="p-8 rounded-3xl bg-[#1C1C1C] border border-white/8 text-white">
                    ...
                    <h4 className="font-serif text-xl mb-3">Qualita editoriale</h4>
                    <p className="text-sm text-white/50 font-light leading-relaxed">
                      Cura editoriale da magazine di viaggio e praticita da guida tecnica. Niente
                      rumore, solo valore.
                    </p>
                  </div>
                </div>
