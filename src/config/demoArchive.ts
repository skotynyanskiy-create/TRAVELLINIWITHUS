...
const SEEDS: ArchiveSeed[] = [
  ...
  },
  {
    ...
    continent: 'Europa',
    destinationGroup: 'Italia',
    experienceTypes: ['Food & Ristoranti', "Borghi e città d'arte", 'Esperienze insolite'],
  ...
  },
  {
    ...
    continent: 'Europa',
    destinationGroup: 'Italia',
    experienceTypes: ['Posti particolari', 'Esperienze insolite', 'Food & Ristoranti'],
  ...
  },
  {
    ...
    continent: 'Europa',
    destinationGroup: 'Italia',
    experienceTypes: ['Locali insoliti', 'Food & Ristoranti', 'Esperienze insolite'],
    period: "Tutto l'anno",
    budget: 'Lean',
    duration: 'Weekend',
    readTime: '6 min',
  ...
  // ====== EUROPA (8) ======
  {
    ...
    experienceTypes: ['Passeggiate panoramiche', 'Posti particolari', 'Esperienze insolite'],
  ...
  },
  {
    ...
    continent: 'Europa',
    destinationGroup: 'Europa',
    experienceTypes: ['Esperienze insolite', 'Passeggiate panoramiche', 'Posti particolari'],
    period: 'Maggio - Settembre',
    budget: 'Medio',
    duration: 'Settimana',
    readTime: '9 min',
  ...
  },
  {
    ...
    continent: 'Europa',
    destinationGroup: 'Europa',
    experienceTypes: ['Locali insoliti', 'Food & Ristoranti', "Borghi e città d'arte"],
    period: "Tutto l'anno",
    budget: 'Lean',
    duration: 'Weekend lungo',
    readTime: '7 min',
  ...
  },
  {
    ...
    continent: 'Asia',
    destinationGroup: 'Asia',
    experienceTypes: ['Esperienze insolite', 'Food & Ristoranti', 'Passeggiate panoramiche'],
  ...
  },
  {
    ...
    continent: 'Asia',
    destinationGroup: 'Asia',
    experienceTypes: ['Posti particolari', 'Hotel con carattere', 'Esperienze insolite'],
  ...
  // ====== AMERICHE (3) ======
  {
    ...
    experienceTypes: ['Passeggiate panoramiche', 'Esperienze insolite', 'Posti particolari'],
  ...
  },
  {
    ...
    continent: 'Americhe',
    destinationGroup: 'Americhe',
    experienceTypes: ['Esperienze insolite', 'Food & Ristoranti', "Borghi e città d'arte"],
    period: 'Novembre - Aprile',
    budget: 'Lean',
    duration: 'Slow trip',
    readTime: '10 min',
  ...
  },
  {
    ...
    continent: 'Americhe',
    destinationGroup: 'Americhe',
    experienceTypes: ['Posti particolari', 'Food & Ristoranti', 'Esperienze insolite'],
    period: 'Novembre - Aprile',
    budget: 'Medio',
    duration: 'Slow trip',
    readTime: '10 min',
  ...
  },
  {
    ...
    continent: 'Africa',
    destinationGroup: 'Africa',
    experienceTypes: ['Esperienze insolite', 'Hotel con carattere', 'Posti particolari'],
    period: 'Maggio - Settembre',
    budget: 'Premium',
    duration: 'Settimana',
    readTime: '11 min',
