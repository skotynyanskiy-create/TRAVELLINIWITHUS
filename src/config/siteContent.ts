...
export const siteContentDefaults: SiteContentMap = {
  ...
  about: {
    ...
    quoteText:
      'Raccontare la verità sul viaggio: i posti bellissimi e le sfide per arrivarci.',
  ...
  collaborations: {
    ...
    services: [
      {
        ...
        description: 'Recensioni su misura, pro e contro inclusi, scritte con il nostro stile da oltre 3.000 parole.',
      },
      {
        title: 'Feature di Destinazione',
        description: 'Una serie di contenuti cross-canale (guida + gallery + reel) dedicati a una singola destinazione.',
      },
      {
        title: 'Press Trip con Libertà Editoriale',
        description: 'Visitiamo la destinazione, produciamo il materiale, ma garantiamo l\'integrità. Raccontiamo quello che vediamo — anche i lati da migliorare.',
      },
      {
        title: 'Feature in Newsletter',
        description: 'Inclusione dedicata nella nostra newsletter, letta da una community di viaggiatori attiva e fidelizzata.',
      },
    ],
    ...
    processSteps: [
      ...
      },
      {
        step: '2',
        title: 'Il Match',
        description: 'Valutiamo se il tuo brand è in linea con il nostro pubblico. Niente compromessi sui valori.',
      },
      {
        step: '3',
        title: 'La Creazione',
        description: 'Lavoriamo con totale libertà editoriale, viaggiando, fotografando e scrivendo in prima persona.',
      },
      {
        step: '4',
        title: 'Il Lancio',
        description: 'Pubblichiamo il pezzo con trasparenza sulla sponsorizzazione, garantendo un posizionamento nativo.',
      },
    ],
    ...
    collaborationFormats: [
      {
        ...
        features: ['Review approfondita sul blog', 'Menzione IG Stories', '1 Link SEO-friendly', 'No approvazione preventiva'],
      },
      {
        title: 'Destination Focus',
        subtitle: 'Campagna Completa',
        features: ['Articolo Guida Completa', 'Pacchetto Foto HR', 'Reel IG & TikTok dedicati', 'Feature Newsletter'],
        highlight: 'true',
      },
      {
        title: 'Bespoke Campaign',
        subtitle: 'Progetti su Misura',
        features: ['Takeover Canali', 'Eventi fisici', 'Produzione Documentario Corto', 'Condivisione dei diritti per uso esterno'],
      },
    ],
  },
  contact: {
...
export const siteContentDefinitions: SiteContentDefinition[] = [
  {
    id: 'home',
    title: 'Home',
    description: 'Hero, CTA, percorsi di ingresso, introduzione al progetto e sezione social della home.',
    previewPath: '/',
    fields: [
      ...
      { key: 'boutiqueIntro', label: 'Introduzione sezione risorse selezionate', type: 'textarea', rows: 4 },
      ...
      { key: 'instagramDescription', label: 'Descrizione card Instagram', type: 'textarea', rows: 3 },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'introParagraphs', label: 'Paragrafi introduttivi', type: 'string-list', itemLabel: 'Paragrafo' },
  ...
  },
  {
    ...
    description: 'Messaggio B2B, servizi, processo, partner ideali e CTA della pagina collaborazioni.',
    ...
    fields: [
      ...
      { key: 'formatsDescription', label: 'Descrizione formati collaborazione', type: 'textarea', rows: 4 },
      {
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'whatsappCardDescription', label: 'Descrizione card WhatsApp', type: 'textarea', rows: 3 },
  ...
  },
  {
    ...
    description: 'Controlli rapidi per mostrare o nascondere i demo pubblici prima della pubblicazione definitiva.',
    previewPath: '/',
    fields: [
      {
        ...
        type: 'boolean',
        description: 'Mantiene online l\'unico articolo o guida demo per vedere il layout finale dei contenuti editoriali.',
      },
      {
        key: 'showDestinationDemo',
        label: 'Mostra demo destinazioni',
        type: 'boolean',
        description: 'Mantiene un solo contenuto demo nella pagina destinazioni e nella mappa quando non hai ancora contenuti reali.',
      },
      {
        key: 'showShopDemo',
        label: 'Mostra demo shop',
        type: 'boolean',
        description: 'Mantiene un solo prodotto demo per vedere il layout boutique e pagina prodotto.',
      },
      {
        key: 'showDemoBadges',
        label: 'Mostra badge demo',
        type: 'boolean',
        description: 'Aggiunge etichette Demo sulle anteprime per rendere chiaro che si tratta di contenuti provvisori.',
      },
    ],
  },
];
