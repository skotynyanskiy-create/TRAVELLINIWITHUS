import { BRAND_COPY, BRAND_STATS } from './site';
...
export const siteContentDefaults: SiteContentMap = {
  home: {
    ...
    quickPillars: [
      'Posti particolari che non finiscono in ogni itinerario copiato.',
      'Guide lunghe, dettagliate e pratiche da usare davvero.',
      'Food experience e indirizzi locali scelti con criterio.',
    ],
    audiencePaths: [
      {
    ...
    socialDescription:
      'Il sito e il posto in cui ordinare meglio il progetto. I social sono il posto in cui vedi il ritmo quotidiano, i dietro le quinte, le scoperte piu immediate e il nostro modo di raccontare mentre siamo in viaggio.',
    ...
    tiktokDescription:
      'Il lato piu rapido e spontaneo del progetto: scorci, idee e contenuti pensati per essere immediati e memorabili.',
    tiktokCta: 'Apri TikTok',
  },
  about: {
    eyebrow: 'Chi siamo e come lavoriamo',
    heroTitleMain: 'Posti particolari',
    heroTitleAccent: BRAND_COPY.aboutHeroAccent,
    introParagraphs: [
      `Siamo Gaetano Rodrigo e Betta, travel couple da ${BRAND_STATS.yearsOfTravel} anni. ${BRAND_COPY.signature}`,
      `Con oltre ${BRAND_STATS.instagramFollowers} su Instagram e ${BRAND_STATS.tiktokFollowers} su TikTok, la Travellini Community e una comunita reale di viaggiatori che si fida di noi, non di sponsorizzazioni travestite da consigli.`,
    ...
    quoteText: 'Raccontare la verita sul viaggio: i posti bellissimi e le sfide per arrivarci.',
    ...
    audienceDescription:
      "Il nostro contenuto non e per tutti. E per chi apprezza l'approfondimento.",
    audienceItems: [
      'Viaggiatori che odiano gli itinerari copia-incolla e vogliono scavare piu a fondo.',
      'Chi cerca strumenti pratici, guide, itinerari e consigli budget che funzionino davvero.',
      'Chi si innamora di una citta mangiando bene senza spendere una fortuna.',
    ],
  },
  collaborations: {
    ...
    heroDescription:
      "Lavoriamo solo con realta che credono nel valore dell'autenticita. Se rappresenti una destinazione, un'esperienza locale o un brand etico e ti fidi della nostra linea editoriale, possiamo creare qualcosa di forte insieme.",
    heroChecklist: [
      'Destinazioni, esperienze locali e brand con valori reali',
      'Liberta editoriale garantita: niente copioni finti',
      'Focus su una qualita altissima di foto e storytelling',
    ...
    statsDescription:
      `Oltre ${BRAND_STATS.instagramFollowers} su Instagram e ${BRAND_STATS.tiktokFollowers} su TikTok, con un engagement rate del ${BRAND_STATS.engagementRate}. Una community di viaggiatori reali, ingaggiata e fidelizzata, costruita in ${BRAND_STATS.yearsOfTravel} anni di contenuti autentici.`,
    ...
    services: [
      ...
      },
      {
        ...
        description:
          "Visitiamo la destinazione, produciamo il materiale, ma garantiamo integrita editoriale. Raccontiamo quello che vediamo, anche i lati da migliorare.",
      },
      {
  ...
  contact: {
    ...
    heroDescription:
      'Per i lettori: domanda su una guida o idea per un articolo? Rispondiamo entro 48 ore. Per i brand: vuoi collaborare? Scrivi con nome brand, idea e budget indicativo.',
    ...
    helperItems: [
      ...
      'Se hai bisogno del media kit, usa anche la pagina dedicata per aprire il contatto in modo piu ordinato.',
      'Se la richiesta e rapida o informale, Instagram e WhatsApp sono spesso i canali piu immediati.',
    ],
    formTitle: 'Inviaci un messaggio',
  },
  footer: {
    description:
      `Budget travel, food experience e posti che valgono davvero, raccontati da Rodrigo e Betta dopo ${BRAND_STATS.yearsOfTravel} anni di strade, tavole e mappe.`,
