 ...
 *
 * Mirror dell'idioma LITE_MODE: la rotta di anteprima `/atlante` viene montata
 * solo quando il flag è attivo, così il build di produzione non la include e la
 * `/` attuale (Sentiero) resta intatta fino al cutover deliberato.
 *
