...
export const POI_CATALOG: Record<string, Poi> = {
  ...
  'sal-otranto-castello': {
    ...
    durationMin: 180,
    bestMonths: [5, 9],
    rbNote: 'Mattino presto o tramonto. A mezzogiorno è un imbuto turistico.',
  },
  'sal-tricase-porto': {
  ...
  'sic-noto-corso': {
    ...
    description: 'Asse barocco di Noto: cattedrale + palazzi + caffè storici.',
    geo: { latitude: 36.8911, longitude: 15.0667 },
    durationMin: 180,
    bestMonths: [4, 5, 10],
    rbNote: "Caffè Sicilia (granita mandorla) è un'istituzione: 5€ ma vale.",
  },
  'sic-favignana-cala': {
  ...
  'sic-modica-cioccolato': {
    ...
    durationMin: 60,
    bestMonths: [1, 2, 3, 4, 5, 9, 10, 11, 12],
    rbNote: 'Provate cannella + sale. Tavolette 4-6€, regali low-cost di alta qualità.',
  },
  ...
  'tos-san-gimignano': {
    ...
    bestMonths: [4, 5, 9, 10],
    avoidMonths: [7, 8],
    rbNote: 'Gelato Dondoli (Piazza Cisterna) è top mondiale ma fila lunga.',
  },
  'tos-val-orcia': {
    id: 'tos-val-orcia',
  ...
  'tos-siena-piazza': {
    ...
    category: 'borgo',
    destinationSlug: 'toscana',
    description: 'Piazza conchiglia + Torre del Mangia 88m. Vista totale città.',
    geo: { latitude: 43.3186, longitude: 11.3306 },
    durationMin: 180,
    bestMonths: [3, 4, 5, 10, 11],
    rbNote: 'Sedersi sui mattoni, ordinare birra dal bar più vicino, aspettare le 17.',
  },
  'tos-lucca-mura': {
    id: 'tos-lucca-mura',
  ...
  'dol-alpe-siusi': {
    ...
    category: 'vista',
    destinationSlug: 'dolomiti',
    description: "Altopiano alpino più esteso d'Europa. Funivia da Siusi/Compatsch.",
  ...
  'sar-bosa-fluviale': {
    ...
    category: 'borgo',
    destinationSlug: 'sardegna',
    description: 'Unica città sarda affacciata su fiume navigabile. Castello dei Malaspina.',
  ...
  'lig-tellaro': {
    ...
    description: 'Borgo a picco sul mare, "uno dei più belli d\'Italia". 800 abitanti.',
  ...
  'lig-vernazza-sentiero': {
    ...
    category: 'vista',
    destinationSlug: 'liguria',
    description: 'Tratto più suggestivo delle Cinque Terre, 3.5 km a strapiombo.',
  ...
  'mrk-jemaa-el-fnaa': {
    ...
    description: 'La piazza più famosa del Marocco: cantastorie, cobra, banchi cibo.',
  ...
  'lis-bairro-alto': {
    ...
    category: 'vista',
    destinationSlug: 'lisbona',
    description: 'Quartiere alto della città. Miradouro de Sao Pedro de Alcantara.',
