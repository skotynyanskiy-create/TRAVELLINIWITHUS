...
Passo di rifinitura per testi lunghi prodotti da agent o da Codex in pipeline editorial. Non genera contenuto nuovo: ripulisce.
...
- `AGENTS.md` — quality bar e routing
