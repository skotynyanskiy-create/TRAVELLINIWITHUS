...
| 7   | InstagramGrid Unsplash + view inventate                             | `src/components/InstagramGrid.tsx`                                 | ✅ FIXED — rimosso campo `views` + rendering; Unsplash → local; TODO[R+B]                                               |
...
- `src/components/InstagramGrid.tsx` — view inventate rimosse + Unsplash → local
