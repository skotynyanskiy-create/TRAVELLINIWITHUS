...
CASES = [
    ...
    ("block_dangerous_bash.py", {"tool_name": "Bash", "tool_input": {"command": "git push origin +main"}}, 2, "force via refspec +"),
    ("block_dangerous_bash.py", {"tool_name": "Bash", "tool_input": {"command": "git push origin +HEAD:main"}}, 2, "force via refspec + con src:dst"),
    ("block_dangerous_bash.py", {"tool_name": "Bash", "tool_input": {"command": "git push origin main"}}, 0, "push normale (deve passare)"),
