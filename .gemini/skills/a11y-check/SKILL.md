...
Per a11y automated WCAG 2.2 AA senza dipendere da Playwright MCP:

- `npm run audit:a11y` — `@axe-core/cli` su home, /collaborazioni, /media-kit, /chi-siamo con tag `wcag2a,wcag2aa,wcag21aa`. Output JSON parsabile, exit-code != 0 se issues critici.

Dettagli e roadmap in [docs/10_Projects/PROJECT_CLI_TOOLING_INTEGRATION.md](../../docs/10_Projects/PROJECT_CLI_TOOLING_INTEGRATION.md).
